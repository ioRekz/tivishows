...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13381 = 0;while(true){
var m_13382 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13382 == null))
{} else
{m_13382.call(null);
if((count_13381 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13383 = (count_13381 + 1);
count_13381 = G__13383;
continue;
}
} else
{}
