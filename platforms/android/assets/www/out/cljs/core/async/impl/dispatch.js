...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14775 = 0;while(true){
var m_14776 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14776 == null))
{} else
{m_14776.call(null);
if((count_14775 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14777 = (count_14775 + 1);
count_14775 = G__14777;
continue;
}
} else
{}
