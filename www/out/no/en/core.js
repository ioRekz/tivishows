...
var url_encode__delegate = function (s,p__11867){var vec__11869 = p__11867;var encoding = cljs.core.nth.call(null,vec__11869,0,null);if(cljs.core.truth_(s))
...
var p__11867 = null;if (arguments.length > 1) {
  p__11867 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return url_encode__delegate.call(this,s,p__11867);};
url_encode.cljs$lang$maxFixedArity = 1;
url_encode.cljs$lang$applyTo = (function (arglist__11870){
var s = cljs.core.first(arglist__11870);
var p__11867 = cljs.core.rest(arglist__11870);
return url_encode__delegate(s,p__11867);
});
...
var url_decode__delegate = function (s,p__11871){var vec__11873 = p__11871;var encoding = cljs.core.nth.call(null,vec__11873,0,null);if(cljs.core.truth_(s))
...
var p__11871 = null;if (arguments.length > 1) {
  p__11871 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return url_decode__delegate.call(this,s,p__11871);};
url_decode.cljs$lang$maxFixedArity = 1;
url_decode.cljs$lang$applyTo = (function (arglist__11874){
var s = cljs.core.first(arglist__11874);
var p__11871 = cljs.core.rest(arglist__11874);
return url_decode__delegate(s,p__11871);
});
...
{var G__11877 = clojure.string.upper_case.call(null,unit);if(new cljs.core.Keyword(null,"else","else",1017020587))
{var G__11878 = unit;if(cljs.core._EQ_.call(null,"B",G__11878))
{return (number * 1000000000);
} else
{if(cljs.core._EQ_.call(null,"M",G__11878))
...
*/
no.en.core.parse_integer = (function parse_integer(s){return no.en.core.parse_number.call(null,s,(function (p1__11879_SHARP_){return parseInt(p1__11879_SHARP_);
}));
});
/**
* Parse `s` as a long number.
*/
no.en.core.parse_long = (function parse_long(s){return no.en.core.parse_number.call(null,s,(function (p1__11880_SHARP_){return parseInt(p1__11880_SHARP_);
}));
});
/**
* Parse `s` as a double number.
*/
no.en.core.parse_double = (function parse_double(s){return no.en.core.parse_number.call(null,s,(function (p1__11881_SHARP_){return parseFloat(p1__11881_SHARP_);
}));
});
/**
* Parse `s` as a float number.
*/
no.en.core.parse_float = (function parse_float(s){return no.en.core.parse_number.call(null,s,(function (p1__11882_SHARP_){return parseFloat(p1__11882_SHARP_);
}));
});
/**
* Format the map `m` into a query parameter string.
*/
no.en.core.format_query_params = (function format_query_params(m){var params = clojure.string.join.call(null,"&",cljs.core.map.call(null,(function (p1__11885_SHARP_){return clojure.string.join.call(null,"=",p1__11885_SHARP_);
}),cljs.core.map.call(null,(function (p1__11884_SHARP_){return (new cljs.core.PersistentVector(null,2,5,cljs.core.PersistentVector.EMPTY_NODE,[no.en.core.url_encode.call(null,cljs.core.name.call(null,cljs.core.first.call(null,p1__11884_SHARP_))),no.en.core.url_encode.call(null,cljs.core.second.call(null,p1__11884_SHARP_))],null));
}),cljs.core.remove.call(null,(function (p1__11883_SHARP_){return clojure.string.blank_QMARK_.call(null,[cljs.core.str(cljs.core.second.call(null,p1__11883_SHARP_))].join(''));
...
*/
no.en.core.format_url = (function format_url(m){return [cljs.core.str(cljs.core.name.call(null,new cljs.core.Keyword(null,"scheme","scheme",4400883991).cljs$core$IFn$_invoke$arity$1(m))),cljs.core.str("://"),cljs.core.str((function (){var map__11887 = m;var map__11887__$1 = ((cljs.core.seq_QMARK_.call(null,map__11887))?cljs.core.apply.call(null,cljs.core.hash_map,map__11887):map__11887);var password = cljs.core.get.call(null,map__11887__$1,new cljs.core.Keyword(null,"password","password",2230889997));var user = cljs.core.get.call(null,map__11887__$1,new cljs.core.Keyword(null,"user","user",1017503549));if(cljs.core.truth_(user))
...
{return cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.mapcat.call(null,(function (p1__11890_SHARP_){return (new cljs.core.PersistentVector(null,2,5,cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.keyword.call(null,no.en.core.url_decode.call(null,cljs.core.first.call(null,p1__11890_SHARP_))),no.en.core.url_decode.call(null,cljs.core.second.call(null,p1__11890_SHARP_))],null));
}),cljs.core.filter.call(null,(function (p1__11889_SHARP_){return cljs.core._EQ_.call(null,2,cljs.core.count.call(null,p1__11889_SHARP_));
}),cljs.core.map.call(null,(function (p1__11888_SHARP_){return clojure.string.split.call(null,p1__11888_SHARP_,/=/);
